...
class SequencePredictor():
    ...
    def create_feed_dict(self, inputs_batch, labels_batch=None, initial_state=None, keep_prob=1.0):
        ...
        feed_dict = {self.inputs_placeholder: inputs_batch, self.dropout_placeholder: keep_prob}
    ...
    def build(self):
        ...
        # Adds placeholder variables to represent the input tensors
        ...
        x = tf.one_hot(self.inputs_placeholder, self.config.num_classes)
